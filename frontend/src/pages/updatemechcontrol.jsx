...
import '../pages/updatemechcontrol.css';


class UpdateMechControl extends Component
{
  constructor(props){
    super();
    this.state={
  ...
  getControl = _ =>{
    fetch('http://localhost:4000/mechControls/'+this.state.id)
      .then(res => {
        return res.json()
     })
    .then(control => {
...
export default UpdateMechControl;
